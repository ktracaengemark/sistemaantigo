			...
			<div class="panel panel-info">\
				<div class="panel-heading">\
					<div class="row">\
						...
						<div class="col-md-3">\
							<label for="ValorCompraProduto'+pt+'">Valor Venda:</label><br>\
							<div class="input-group id="ValorCompraProduto'+pt+'">\
								<span class="input-group-addon" id="basic-addon1">R$</span>\
								<input type="text" class="form-control Valor" id="ValorCompraProduto'+pt+'" maxlength="10" placeholder="0,00" \
									name="ValorCompraProduto'+pt+'" value="">\
							</div>\
						</div>\
						<div class="col-md-1">\
							<label><br></label><br>\
        ...
        success: function (data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                if (data[i].id == id) {
                    ...
                    if ($("#QtdCompra"+campo2+num).val()) {
                        calculaSubtotalDev($("#idTab_"+campo2+num).val(),$("#QtdCompra"+campo2+num).val(),num,'OUTRO',campo2);
                        break;
                    }
...
/*
    ...
    while (i <= sc) {
        ...
        if ($('#SubtotalServico'+i).val())
            //subtotal += parseFloat($('#idTab_Produto'+i).val().replace(".","").replace(",","."));
        ...
        <div class="form-group" id="1div'+ps+'">\
            <div class="panel panel-info">\
                <div class="panel-heading">\
                    <div class="row">\
						<div class="col-md-2">\
                            ...
                            <div class="input-group">\
                                <input type="text" class="form-control Numero" maxlength="3" id="QtdCompraProduto'+ps+'" placeholder="0"\
                                    onkeyup="calculaSubtotal(this.value,this.name,'+ps+',\'QTD\',\'Servico\')"\
                                    name="QtdCompraProduto'+ps+'" value="">\
                            </div>\
                        </div>\
						<div class="col-md-4">\
                            <label for="idTab_Produto">Serviços:</label><br>\
                            <select class="form-control" id="listadinamica'+ps+'" onchange="buscaValor(this.value,this.name,\'Servico\','+ps+')" name="idTab_Produto'+ps+'">\
                                <option value="">-- Selecione uma opção --</option>\
                            </select>\
                        </div>\
                        <div class="col-md-3">\
                            <label for="ValorCompraProduto">Valor do Serviço:</label><br>\
                            <div class="input-group" id="txtHint">\
                                <span class="input-group-addon" id="basic-addon1">R$</span>\
                                <input type="text" class="form-control Valor" id="idTab_Produto'+ps+'" maxlength="10" placeholder="0,00" \
                                    onkeyup="calculaSubtotal(this.value,this.name,'+ps+',\'VP\',\'Servico\')"\
                                    name="ValorCompraProduto'+ps+'" value="">\
                            </div>\
                        </div>\
                        <div class="col-md-3">\
                    ...
                    <div class="row">\
                        <div class="col-md-6">\
                            <label for="ObsProduto'+ps+'">Obs:</label><br>\
                            <input type="text" class="form-control" id="ObsProduto'+ps+'" maxlength="250"\
                                   name="ObsProduto'+ps+'" value="">\
                        </div>\
                        <div class="col-md-3">\
            ...
            <div class="panel panel-info">\
                <div class="panel-heading">\
                    <div class="row">\
						...
						<div class="col-md-4">\
                            <label for="idTab_Produto">Serviços:</label><br>\
                            <select class="form-control" id="listadinamica'+ps+'" onchange="buscaValorCompra(this.value,this.name,\'Servico\','+ps+')" name="idTab_Produto'+ps+'">\
                                <option value="">-- Selecione uma opção --</option>\
                            </select>\
                        </div>\
                        <div class="col-md-3">\
					...
					<div class="panel-heading">\
						<div class="row">\
							<div class="col-md-1">\
								...
								<div class="input-group">\
									<input type="text" class="form-control Numero" maxlength="3" id="QtdCompraProduto'+ps+'" placeholder="0"\
										onkeyup="calculaSubtotalDev(this.value,this.name,'+ps+',\'QTD\',\'Servico\'),calculaQtdSomaDev(\'QtdCompraProduto\',\'QtdSomaDev\',\'ServicoSoma\',0,0,\'CountMax2\',0,\'ServicoHidden\')"\
										name="QtdCompraProduto'+ps+'" value="">\
								</div>\
							</div>\
							<div class="col-md-7">\
								<label for="idTab_Produto">Produto:</label><br>\
								<select class="form-control Chosen" id="listadinamica'+ps+'" onchange="buscaValor2Tabelas(this.value,this.name,\'Valor\','+ps+',\'Produto\')" name="idTab_Produto'+ps+'">\
									<option value="">-- Selecione uma opção --</option>\
								</select>\
							</div>\
							<div class="col-md-2">\
						...
						<div class="row">\
							...
							<div class="col-md-2">\
								<label for="DataValidadeProduto'+ps+'">Valid. do Prod:</label>\
								<div class="input-group DatePicker">\
									<span class="input-group-addon" disabled>\
										<span class="glyphicon glyphicon-calendar"></span>\
									</span>\
									<input type="text" class="form-control Date" maxlength="10" placeholder="DD/MM/AAAA"\
										   name="DataValidadeProduto'+ps+'" value="'+currentDate.format('DD/MM/YYYY')+'">\
								</div>\
							</div>\
							<div class="col-md-1">\
								<label><br></label><br>\
								<a href="#" id="'+ps+'" class="remove_field btn btn-danger"\
									onclick="calculaQtdSomaDev(\'QtdCompraProduto\',\'QtdSomaDev\',\'ServicoSoma\',1,'+ps+',\'CountMax2\',0,\'ServicoHidden\')">\
									<span class="glyphicon glyphicon-trash"></span>\
								</a>\
							</div>\
						</div>\
					...
					<div class="panel-heading">\
						<div class="row">\
							<div class="col-md-1">\
								...
								<div class="input-group">\
									<input type="text" class="form-control Numero" maxlength="3" id="QtdCompraProduto'+ps+'" placeholder="0"\
										onkeyup="calculaSubtotalDev(this.value,this.name,'+ps+',\'QTD\',\'Produto\'),calculaQtdSomaDev(\'QtdCompraProduto\',\'QtdSomaDev\',\'ServicoSoma\',0,0,\'CountMax2\',0,\'ServicoHidden\')"\
										name="QtdCompraProduto'+ps+'" value="">\
								</div>\
							</div>\
							<div class="col-md-3">\
								<label for="idTab_Produto">Produto:</label><br>\
								<select class="form-control Chosen" id="listadinamica'+ps+'" onchange="buscaValorDevTabelas(this.value,this.name,\'Valor\','+ps+',\'Produto\')" name="idTab_Produto'+ps+'">\
									<option value="">-- Selecione uma opção --</option>\
								</select>\
							</div>\
							<div class="col-md-3">\
						...
						<div class="row">\
							...
							<div class="col-md-2">\
								<label for="DataValidadeProduto'+ps+'">Validade:</label>\
								<div class="input-group DatePicker">\
									<span class="input-group-addon" disabled>\
										<span class="glyphicon glyphicon-calendar"></span>\
									</span>\
