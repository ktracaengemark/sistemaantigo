...
function descPercOrca(usarcash){
	...
	console.log('PercDesc - cashbackorca = ' + cashbackorca);
	...
	if(valortotalorca > 0){
		...
		if(descpercorca <= 100){	
			...
			console.log('PercDesc subvalorfinal = ' + subvalorfinal);
			...
			console.log('PercDesc. valorfinalorca = ' + valorfinalorca);
