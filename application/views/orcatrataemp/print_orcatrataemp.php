	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="panel-heading text-center">
				<h3><?php echo '<strong>' . $_SESSION['Usuario']['NomeConsultor'] . '</strong>' ?></h3>
			</div>

			<div class="panel-body">

				<hr />
				<?php echo '<h4>Usuario: ' . $_SESSION['Usuario']['Nome'] . ' - Id: ' . $_SESSION['Usuario']['idSis_Empresa'] . ' - <strong>ORÇAMENTO</strong> - <strong>Nº: ' . $_SESSION['Orcatrata']['idApp_OrcaTrataEmp'] . '</strong></h4>' ?>
				<hr />
				...
				<table class="table table-bordered table-condensed table-striped">
					...
					<tbody>
						...
						<tr>
							<!--<td><?php echo $produto[$i]['idApp_OrcaTrataEmp'] ?></td>-->
						...
						<tr>
							<td></td>
							<td><?php echo $produto[$i]['idApp_ProdutoVendaEmp'] ?></td>
				...
				<table class="table table-bordered table-condensed table-striped">
					...
					<tbody>
						...
						<tr>
							<td></td>
							<td><?php echo $servico[$i]['idApp_ServicoVendaEmp'] ?></td>
