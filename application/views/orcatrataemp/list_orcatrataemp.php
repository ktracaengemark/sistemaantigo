					...
					<nav class="navbar navbar-inverse">
					  <div class="container-fluid">
						<div class="navbar-header">
						  ...
						  <a class="navbar-brand" href="<?php echo base_url() . 'cliente/prontuario/' . $_SESSION['Usuario']['idSis_Empresa']; ?>">
							<?php echo '<small>' . $_SESSION['Usuario']['Nome'] . '</small> - <small>Id.: ' . $_SESSION['Usuario']['idSis_Empresa'] . '</small>' ?>
						  </a>
						</div>
						<div class="collapse navbar-collapse" id="myNavbar">
							...
							<ul class="nav navbar-nav navbar-center">
								<li>
									<a href="<?php echo base_url() . 'cliente/alterar/' . $_SESSION['Usuario']['idSis_Empresa']; ?>">
										<span class="glyphicon glyphicon-edit"></span> Editar Usuario
									</a>
								</li>
								
								<li>
									<a href="<?php echo base_url() . 'cliente/acomp/' . $_SESSION['Usuario']['idSis_Empresa']; ?>">
										<span class="glyphicon glyphicon-pencil"></span> Anotações
									</a>
								</li>								

								<li>
									<a href="<?php echo base_url() . 'orcatrataemp/listar/' . $_SESSION['Usuario']['idSis_Empresa']; ?>">
										<span class="glyphicon glyphicon-usd"></span> Ver Orçams.
									</a>
								</li>

								<li>
									<a href="<?php echo base_url() . 'orcatrataemp/cadastrar/' . $_SESSION['Usuario']['idSis_Empresa']; ?>">
										...
										<div class="tab-content">
											...
											<div role="tabpanel" class="tab-pane active " id="proxima">
												...
												<div class="bs-callout bs-callout-success" id=callout-overview-not-both>
													...
													<a class="btn btn-success" href="<?php echo base_url() . 'orcatrataemp/alterar/' . $row['idApp_OrcaTrataEmp'] ?>" role="button">
														<span class="glyphicon glyphicon-edit"></span> Editar Dados
													</a>
													
														
													<a class="btn btn-md btn-info" target="_blank" href="<?php echo base_url() . 'OrcatrataPrintcons/imprimir/' . $row['idApp_OrcaTrataEmp']; ?>" role="button">
													...
													<h4>
														<span class="glyphicon glyphicon-tags"></span> <b>Nº Orç.:</b> <?php echo $row['idApp_OrcaTrataEmp']; ?>
													</h4>
													<h5>
											...
											<div role="tabpanel" class="tab-pane " id="anterior">
												...
												<div class="bs-callout bs-callout-danger" id=callout-overview-not-both>
													...
													<a class="btn btn-danger" href="<?php echo base_url() . 'orcatrataemp/alterar/' . $row['idApp_OrcaTrataEmp'] ?>" role="button">
														<span class="glyphicon glyphicon-edit"></span> Editar Dados
													</a>
