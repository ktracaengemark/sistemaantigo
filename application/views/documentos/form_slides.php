				...
				<div class="panel-body">
										...
										<div class="col-md-12 ">
											<div class="row">	
												<a href="<?php echo base_url() . 'relatorio/slides/'; ?>">
													<img alt="User Pic" src="<?php echo base_url() . 'arquivos/imagens/empresas/' . $_SESSION['Empresa']['idSis_Empresa'] . '/documentos/miniatura/' . $_SESSION['Documentos']['Logo_Nav'] . ''; ?>" 
					...
					<div class="form-group">
						<div class="row">
							...
							<input type="hidden" name="idApp_Documentos" value="<?php echo $file['idApp_Documentos']; ?>">
							<div class="col-md-6">                            
