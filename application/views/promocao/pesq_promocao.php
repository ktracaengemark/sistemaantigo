	  ...
	  <div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" data-toggle="collapse" data-target="#myNavbar"> 
				 <span class="glyphicon glyphicon-list"></span> Promocao
			</a>
			<!--
				...
				<li class="btn-toolbar btn-sm navbar-form" role="toolbar" aria-label="...">
					...
					<div class="btn-group">
						<button type="button" class="btn btn-sm btn-warning dropdown-toggle" data-toggle="dropdown">
							<span class="glyphicon glyphicon-gift"></span> Promocao <span class="caret"></span>
						</button>
						<ul class="dropdown-menu" role="menu">							
							<li><a href="<?php echo base_url() ?>relatorio/promocao"><span class="glyphicon glyphicon-usd"></span> Promocao</a></li>
						...
						<div class="row">									
							...
							<div class="col-md-2">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control Valor" maxlength="10" placeholder="0,00"
											name="ValorCompraProduto" value="<?php echo $promocao['ValorCompraProduto'] ?>">
								</div>
							</div>
							...
							<div class="col-md-2">
								...
								<div class="input-group">
									<span class="input-group-addon" id="basic-addon1">R$</span>
									<input type="text" class="form-control Valor" maxlength="10" placeholder="0,00"
											name="ValorProduto" value="<?php echo $promocao['ValorProduto'] ?>">
								</div>
							</div>
							-->
						</div>
...
<div class="modal fade bs-excluir-modal5-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			<div class="modal-header bg-danger">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title"><span class="glyphicon glyphicon-filter"></span> Filtros dos Promocao</h4>
			</div>
			<div class="modal-footer">
...
<div class="modal fade bs-excluir-modal4-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header bg-danger">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">Evite cadastrar Promocao REPETIDOS!<br>
										"Pesquise" os Promocao Cadastradas!</h4>
			</div>
			<!--
			<div class="modal-body">
				<p>Pesquise os Promocao Cadastrados!!</p>
			</div>
			-->
			<div class="modal-footer">
				...
				<div class="form-group col-md-4 text-right">
					<div class="form-footer">		
						<a class="btn btn-danger btn-block" href="<?php echo base_url() ?>promocao/cadastrar1" role="button">
							<span class="glyphicon glyphicon-plus"></span> Promocao
						</a>
					</div>	
				</div>
				<?php } else {?>
