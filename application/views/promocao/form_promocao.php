	...
	<div class="panel panel-<?php echo $panel; ?>">
		<div class="panel-heading">
			...
			<a class="btn btn-sm btn-info" href="<?php echo base_url() ?>relatorio/promocao" role="button">
				<span class="glyphicon glyphicon-search"></span> Promocoes
			</a>
				...
				<div class="panel panel-info">
					<div class="panel-heading">	
						<div class="row">
							...
							<div id="Desconto" <?php echo $div['Desconto']; ?>>
								<div class="col-md-3">
												...
												<div class="panel-heading">
													<div class="row">	
														<div class="col-md-12">
															...
															<?php }else { ?>
																<input type="hidden" id="Cat_1" name="Cat_1" value="<?php echo $promocao['Cat_1']; ?>"/>
																<?php echo '<strong>" ' . $_SESSION['Promocao']['Cat1'] . ' "</strong>' ?>
																<br>
															<?php } ?>
													...
													<div class="panel-heading">
														<div class="row">	
															<div class="col-md-12">
																...
																<?php }else { ?>
																	<input type="hidden" id="Cat_2" name="Cat_2" value="<?php echo $promocao['Cat_2']; ?>"/>
																	<?php echo '<strong>" ' . $_SESSION['Promocao']['Cat2'] . ' "</strong>' ?>
																	<br>
																<?php } ?>
													...
													<div class="panel-heading">
														<div class="row">	
															<div class="col-md-12">
																...
																<?php }else { ?>
																	<input type="hidden" id="Cat_3" name="Cat_3" value="<?php echo $promocao['Cat_3']; ?>"/>
																	<?php echo '<strong>" ' . $_SESSION['Promocao']['Cat3'] . ' "</strong>' ?>
																	<br>
																<?php } ?>
