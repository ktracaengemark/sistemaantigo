				...
				<div class="panel panel-primary">
					<div class="panel-heading"><strong><?php echo $titulo; ?></strong>
						...
						<div class="text-left ">											
							...
							<a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>empresafilial/cadastrar" role="button"> 
								<span class="glyphicon glyphicon-plus"></span> Nova Filial
							</a>
						</div>					
									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											<div class="form-group text-left">
												<div class="row">                           								
													<div class="col-md-6">
														<label for="Ordenamento">Unidade / Filial:</label>
