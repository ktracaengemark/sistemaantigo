			...
			<div class="main">
				...
				<div class="panel panel-primary">
					<div class="panel-heading"><strong><?php echo $titulo; ?></strong>
						...
						<?php echo form_open('relatorioempresamatriz/funcionario', 'role="form"'); ?>
						...
						<div class="text-left ">											
							...
							<a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>funcionariomatriz/cadastrar" role="button"> 
									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											<div class="form-group text-left">
												<div class="row">                           								
													<div class="col-md-6">
														<label for="Ordenamento">Nome do Funcionário:</label>
