			...
			<div class="main">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<?php echo form_open('relatorioempresa/orcamentoempresa', 'role="form"'); ?>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-2 text-right">											
									<a class="btn btn-lg btn-danger" href="<?php echo base_url() ?>orcatrata2empresa/cadastrar" role="button"> 
