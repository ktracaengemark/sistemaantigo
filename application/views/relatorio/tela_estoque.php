...
<div class="col-sm-offset-2 col-md-8 ">		
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-center">
				...
				<li class="btn-toolbar btn-sm navbar-form" role="toolbar" aria-label="...">
					...
					<!--
					<div class="btn-group " role="group" aria-label="...">
						<a <?php if (preg_match("/relatorio\/produtos\b/", $_SERVER['REQUEST_URI'])) echo 'class=active'; ///(.)+\/cadastrar1/    ?>>
							<a href="<?php echo base_url() . 'relatorio/produtos/'; ?>">
								<button type="button" class="btn btn-sm btn-default ">
									<span class="glyphicon glyphicon-edit"></span> Produtos
								</button>										
							</a>
						</a>
					</div>
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<span class="glyphicon glyphicon-pencil"></span> ESTOQUE
		</div>		
