	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="panel-body">
				...
				<hr />
				<?php echo '<h4>Usuario: ' . $_SESSION['Usuario']['Nome'] . ' - Id: ' . $_SESSION['Usuario']['idApp_Cliente'] . ' - <strong>ORÇAMENTO</strong> - <strong>Nº: ' . $_SESSION['Orcatrata']['idApp_OrcaTrataCli'] . '</strong></h4>' ?>
				<hr />
				...
				<table class="table table-bordered table-condensed table-striped">
					...
					<tbody>
						...
						<tr>
							<!--<td><?php echo $produto[$i]['idApp_OrcaTrataCli'] ?></td>-->
						...
						<tr>
							<td></td>
							<td><?php echo $produto[$i]['idApp_ProdutoVendaCli'] ?></td>
				...
				<table class="table table-bordered table-condensed table-striped">
					...
					<tbody>
						...
						<tr>
							<td></td>
							<td><?php echo $servico[$i]['idApp_ServicoVendaCli'] ?></td>
