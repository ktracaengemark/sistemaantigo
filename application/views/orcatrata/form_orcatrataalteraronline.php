									...
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-md-4">
												...
												<input type="text" class="form-control" maxlength="200" readonly=''
														...
														<div class="panel-heading">
															<div class="row">														
																<div class="col-md-12 text-center">
																	<label for="ConcluidoOrca">Todos Prd. Entregues?</label><br>
																	<div class="btn-group" data-toggle="buttons">
																		<?php
													...
													<div class="panel-heading">
														<div class="row">
															...
															<div class="col-md-6">
																...
																<select data-placeholder="Selecione uma opção..." class="form-control" <?php echo $readonly; ?> readonly=''
