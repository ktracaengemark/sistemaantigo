			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class=" btn btn-info" type="button" data-toggle="collapse" data-target="#NaoDevolvidos" aria-expanded="false" aria-controls="NaoDevolvidos">
						<span class="glyphicon glyphicon-chevron-up"></span> Não Devolvidos - Aluguel no Balcão
					</div>			
				</div>
													...
													<div class="panel-heading">
														<div class="row">														
															<div class="col-md-12">
																...
																<strong><?php echo $online['NomeCliente']?></strong>
											...
											<div class="col-md-4 panel-body">
												<div class="panel panel-warning">
													<div class="panel-heading">
														<div class="row">														
															<div class="col-md-12">
																<label>Tipo de Receita:</label><br>
																<strong><?php echo $online['TipoFinanceiro']?></strong>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="panel-heading">
														<div class="row">											
															<div class="col-md-4">
																...
																<strong><?php echo $online['Descricao']?></strong>
															</div>
														</div>
													</div>
												</div>
																		...
																		<div class="panel-heading">
																			<div class="row">
																				...
																				<div class="col-md-6">
																					...
																					<?php } ?>
																					<select data-placeholder="Selecione uma opção..." class="form-control Chosen" onchange="buscaValor2Tabelas(this.value,this.name,'Valor',<?php echo $i ?>,'Produto')" <?php echo $readonly; ?> readonly=''
																			...
																			<div class="row">
																				...
																				<div class="col-md-2">
																					<label for="idSis_Usuario<?php echo $i ?>">Profissional:</label><br>
																					<strong><?php echo $produto[$i]['idSis_Usuario']; ?></strong>
																					<!--
																					<?php if ($i == 1) { ?>
																					<?php } ?>
																				...
																				<div class="col-md-2">
																					...
																					<textarea class="form-control" id="ObsProduto<?php echo $i ?>" <?php echo $readonly; ?> readonly=''
														...
														<div class="panel-heading">
															<div class="row">				
																<div class="col-md-6">
																	...
																	<strong> <?php echo $online['ValorOrca']?> </strong>
																</div>
																<div class="col-md-6">
																	<label for="ValorDev">Desconto:</label><br>
																	<strong> <?php echo $online['ValorDev']?> </strong>
																</div>
															</div>
														</div>
													</div>
													...
													<div class="panel panel-success">
														<div class="panel-heading">
															<div class="row">
																<div class="col-md-4">
																	<label for="ValorRestanteOrca">Total:</label><br>
																	<strong> <?php echo $online['ValorRestanteOrca']?> </strong>
																</div>																
																<div class="col-md-6">
																	<label for="DataOrca">Dta Orçam:</label><br>
																	<strong> <?php echo $online['DataOrca']?> </strong>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="panel-heading">
															<div class="row">
																<div class="col-md-6">
																	...
																	<strong> <?php echo $online['AVAP']?> </strong>
																</div>															
																<div class="col-md-6">
																	<label for="FormaPagamento">Pago Com:</label><br>
																	<strong> <?php echo $online['FormaPagamento']?> </strong>
																</div>
															</div>
														</div>
													</div>
														...
														<div class="panel-heading">
															<div class="row">														
																<div class="col-md-12 text-center">
																	<label for="EnviadoOrca">Produtos Enviados?</label><br>
																	<div class="btn-group" data-toggle="buttons">
																		<?php
										...
										<div class="panel-heading">
												...
												<div class="row">
													<div class="col-md-2">
														...
														<strong> <?php echo $online['Modalidade']?> </strong>
													</div>													
													
													<div class="col-md-2">
														<label for="QtdParcelasOrca">Qtd. Parcelas</label><br>
														<strong> <?php echo $online['QtdParcelasOrca']?> </strong>
													</div>
													
													<div class="col-md-2">
														<label for="DataVencimentoOrca">Venc.</label><br>
														<strong> <?php echo $online['DataVencimentoOrca']?> </strong>
													</div>
												</div>
											<!--App_parcelasRec-->
											<div class="panel-body">
													...
													<div class="col-md-4 panel-body">
														<div class="panel panel-primary">
															<div class="panel-heading">
																<div class="row">
																	<div class="col-md-12 text-center">
																		<label for="QuitadoOrca">Todas As Parcelas Pagas?</label><br>
																		<div class="btn-group" data-toggle="buttons">
																			<?php
									...
									<div class="panel-heading">
										<div class="row">
											...
											<div class="col-md-6">	
												...
												<input type="hidden" name="idSis_Usuario" value="<?php echo $orcatrata['idSis_Usuario']; ?>">
