						...
						<div class="panel-body">
							<div style="overflow: auto; height: auto; ">
								...
								<div class="panel-group">	
										...
										<!--
										<div class="panel-heading text-left">
											<a class="btn btn-danger" type="button" data-toggle="collapse" data-target="#Orcamento" aria-expanded="false" aria-controls="Orcamento">
																			...
																			<div class="panel-heading">
																				<div class="row">														
																					<div class="col-md-12 text-center">
																						<label for="ConcluidoOrca">Prd.Entregues?</label><br>
																						<div class="btn-group" data-toggle="buttons">
																							<?php
																	...
																	<div class="col-md-2 panel-body">
																		<div class="panel panel-danger">
																			<div class="panel-heading">
																				<div class="row">														
																					<div class="col-md-12 text-center">
																						<label for="DevolvidoOrca">Prd.Devolvidos?</label><br>
																						<div class="btn-group" data-toggle="buttons">
																							<?php
															...
															<div class="col-md-4 panel-body">
																<div class="panel panel-warning">
																	<div class="panel-heading">
																		<div class="row">
																			<div class="col-md-12 text-center">
																				<label for="QuitadoOrca">Todas as Parcelas Quitadas?</label><br>
																				<div class="btn-group" data-toggle="buttons">
																					<?php
													...
													<div class="col-md-3 text-left">
														...
														<div class="btn-group" data-toggle="buttons">
															...
															foreach ($select['AprovadoOrca'] as $key => $row) {
																#if (!$orcatrata['AprovadoOrca']) $orcatrata['AprovadoOrca'] = 'N';
