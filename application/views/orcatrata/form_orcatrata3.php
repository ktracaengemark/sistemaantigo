													...
													<div class="col-md-12">
														<div class="row">
															...
															<div class="col-md-4 text-left" id="Cadastrar" <?php echo $div['Cadastrar']; ?>>
																<label for="Cadastrar">Cadastrar Cliente</label><br>
									...
									<div id="TipoFrete" <?php echo $div['TipoFrete']; ?>>
										...
										<div class="row ">
											<div class="col-md-2 mb-3 ">	
												...
												<button class=" form-control btn btn-lg btn-success" type="button" onclick="Procuraendereco()" >Buscar</button>
											</div>
											<div class="col-md-2 ">
														...
														<div class="panel-heading">
															<div class="row">
																<div class="col-md-6 mb-3">
																	<label for="PrazoProdServ">PrazoProdServ (Dias)</label>
																...
																<div class="col-md-6 mb-3">
																	<label for="PrazoCorreios">PrazoCorreios (Dias)</label>
										...
										<div class="col-md-4">
											<div class="panel panel-default">
												<div class="panel-heading">
													<div class="row">
														<div class="col-md-6 mb-3">
															<label for="PrazoEntrega">PrazoTotal (Dias)</label>
