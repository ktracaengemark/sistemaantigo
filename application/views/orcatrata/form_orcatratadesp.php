											...
											<div class="col-md-8">
												<div class="panel panel-default">
													<div class="panel-heading">
														<div class="row">
															<div class="col-md-4">
																<label for="ValorExtraOrca">Despesa:</label>
																<div class="input-group" id="txtHint">
																	<span class="input-group-addon " id="basic-addon1">R$</span>
									...
									<div class="panel-heading">	
											...
											<div class="col-md-4">
												<div class="panel panel-default">
													<div class="panel-heading">
														<div class="row">
															<div class="col-md-12">
																<label for="ValorTotalOrca">Total da Despesa:</label><br>
																<div class="input-group" id="txtHint">
																	<span class="input-group-addon" id="basic-addon1">R$</span>
										...
										<div>
											...
											<div class="input_fields_parcelas">
												<?php if($orcatrata['ValorTotalOrca'] > 0) { ?>
													<?php
																...
																<div class="col-md-12 text-left">
																	...
																	<div class="btn-group" data-toggle="buttons">
																		...
																		foreach ($select['CombinadoFrete'] as $key => $row) {
																			if (!$orcatrata['CombinadoFrete'])$orcatrata['CombinadoFrete'] = 'N';
