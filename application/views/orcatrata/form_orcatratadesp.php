						...
						<div class="panel-group">
							<div class="panel panel-success">
								<div class="panel-heading">
									...
									<div class="form-group">	
										<div class="row">
											...
											<div class="col-md-4 text-left">
												<label for="DataOrca">Data da Despesa</label>
											...
											<?php if ($_SESSION['log']['NivelEmpresa'] >= 4 ) { ?>
												<div class="col-md-4 text-left">	
													<div class="row">
														<div class="col-md-4 text-left">
															<label for="Cli_Forn_Orca">Com Fornec?</label><br>
															<div class="btn-group" data-toggle="buttons">
																...
																foreach ($select['Cli_Forn_Orca'] as $key => $row) {
																	...
																	if ($orcatrata['Cli_Forn_Orca'] == $key) {
																		...
																		//. 'onchange="comfornecedor(this.value)" '
												...
												<div class="panel-heading text-left">																					
													<div class="row">
														<div class="col-md-3 text-left">
															<label for="ConcluidoOrca">Tudo Entregue?</label><br>
															<?php if ($_SESSION['Usuario']['Bx_Prd'] == "S") { ?>
																<div class="btn-group" data-toggle="buttons">
																	<?php
									...
									<?php }else{ ?>	
										<input type="hidden" class="form-control Valor" name="ValorRestanteOrca" id="ValorRestanteOrca" value="<?php echo $orcatrata['ValorRestanteOrca'] ?>" readonly=''/>
										<input type="hidden" name="ValorComissao" id="ValorComissao" value="<?php echo $orcatrata['ValorComissao'] ?>" readonly=''>
									<?php } ?>
								</div>
							</div>
							<?php if ($_SESSION['log']['NivelEmpresa'] >= 4 ) { ?>
									...
									<div class="panel-heading">	
										...
										<div class="row">
											...
											<?php }else{ ?>
												...
												<input type="hidden" class="form-control Valor" name="SubValorFinal" id="SubValorFinal" value="<?php echo $orcatrata['SubValorFinal'] ?>" readonly=''/>
												<input type="hidden" class="form-control Valor" name="CashBackOrca" id="CashBackOrca" value="<?php echo $orcatrata['CashBackOrca'] ?>" readonly=''/>
												<input type="hidden" class="form-control Valor" name="ValorFinalOrca" id="ValorFinalOrca" value="<?php echo $orcatrata['ValorFinalOrca'] ?>" readonly=''/>
											<?php } ?>
															...
															<div class="col-md-3">
																<div class="panel panel-success">
																	<div class="panel-heading">
																		<div class="row">
																			<div class="col-md-12 text-left">
																				<label for="ProntoOrca">Produtos Prontos para Entrega?</label><br>
																				<div class="btn-group" data-toggle="buttons">
																					<?php
												...
												<div class="col-md-3">
													<div class="panel panel-primary">
														<div class="panel-heading">
															...
															<div class="row">
																<div class="col-md-12 text-center">
																	<h4>Produtos Entregues e<br>Parecelas Pagas</h4>
																</div>
															</div>
														</div>
													</div>
