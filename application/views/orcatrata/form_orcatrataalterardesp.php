																							...
																							<div class="panel-heading">
																								<div class="row">
																									...
																									<div class="col-md-3">
																										...
																										<?php } ?>
																										<select data-placeholder="Selecione uma opção..." class="form-control Chosen" onchange="buscaValor(this.value,this.name,'Valor',<?php echo $i ?>,'Produto')" <?php echo $readonly; ?>
																					...
																					<div class="panel panel-warning">
																						<div class="panel-heading text-left">
																							...
																							<div class="row">	
																								...
																								<div class="col-md-3 text-left">
																									<a class="add_field_button12  btn btn-warning" 
