										...
										<ul class="dropdown-menu" role="menu">
											...
											<li>
												<a <?php if (preg_match("/orcatrata\/cadastrar\b/", $_SERVER['REQUEST_URI'])) echo 'class=active'; ///(.)+\/cadastrar1/    ?>>
													<a href="<?php echo base_url() . 'orcatrata/cadastrar/' . $query['idApp_Cliente']; ?>" onclick="buscaEnderecoCliente(<?php echo $query['idApp_Cliente'];?>)">
																...
																<div class="panel-heading">
																	...
																	<div class="row">
																		...
																		<div class="col-md-2">
																			...
																			<div class="input-group">
																				<input type="text" class="form-control Numero text-right" maxlength="10" readonly="" id="SubtotalQtdProduto<?php echo $i ?>"
