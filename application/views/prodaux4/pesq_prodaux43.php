				...
				<div class="panel-body">
					...
					<?php echo form_open($form_open_path, 'role="form"'); ?>
						...
						<div class="form-group">
							<div class="row">
								<input type="hidden" name="idTab_Prodaux4" value="<?php echo $query['idTab_Prodaux4']; ?>">
								<?php if ($metodo == 2) { ?>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<div class="col-md-6 text-right">
														<a class="btn btn-danger" href="<?php echo base_url() . 'prodaux42/excluir3/' . $query['idTab_Prodaux4'] ?>" role="button">
