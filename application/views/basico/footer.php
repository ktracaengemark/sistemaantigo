        ...
        <script src="<?php echo base_url(); ?>js/bootstrap-table-pt-BR.js"></script>
        ...
        <script src="<?php echo base_url(); ?>js/jquery.chained.remote.js"></script>      
        <script src="<?php echo base_url(); ?>js/fileinput.js"></script>
        <script src='<?php echo base_url(); ?>js/fullcalendar.js'></script>
        <script src='<?php echo base_url(); ?>js/fullcalendar-lang-pt-br.js'></script>
        ...
        <!-- arquivo js que carrega funções personalizadas de javascript. deve vir sempre após carregar todos os outros arquivos js -->
