		...
		<div class="row">
			...
			<div class="col-md-9 ">
				<div class="navbar-header ">
					...
					<!--<a class="navbar-brand"> <?php echo $_SESSION['log']['NomeEmpresa']; ?>
					</a>-->
					<a class="navbar-brand" href="<?php echo base_url() ?>acesso/index"> 
						<?php echo $_SESSION['log']['NomeEmpresa2']; ?>/<?php echo $_SESSION['log']['NomeEmpresa']; ?>
					</a>
				</div>
					...
					<ul class="nav navbar-nav navbar-center">
						...
						<li class="btn-toolbar navbar-form" role="toolbar" aria-label="...">
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">							
									<li><a href="<?php echo base_url() ?>orcatratacli/cadastrar2"><span class="glyphicon glyphicon-usd"></span> Receitas</a></li>
									<li role="separator" class="divider"></li>							
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">
									<li><a href="<?php echo base_url() ?>relatorio/receitas"><span class="glyphicon glyphicon-list"></span> Receitas</a></li>
									<li role="separator" class="divider"></li>
