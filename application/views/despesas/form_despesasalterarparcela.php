				...
				<div class="panel-body">
							...
							<div id="collapse2" class="panel-collapse" role="tabpanel" aria-labelledby="heading2" aria-expanded="false">									
								...
								<div class="panel-body">
									...
									?>
										...
										<div class="form-group" id="23div<?php echo $i ?>">
											<div class="panel panel-warning">
												<div class="panel-heading">
													...
													<div class="row">
														...
														<div class="col-md-2 text-right">
															<label><br></label><br>
															<button type="button" id="<?php echo $i ?>" class="remove_field23 btn btn-danger">
									...
									<div class="panel panel-warning">
										<div class="panel-heading">										
											<div class="row">	
												<div class="col-md-2">
													<a class="btn btn-warning" type="button" data-toggle="collapse" onclick="adicionaParcelasPagaveisAlterar()"
					...
					<div class="form-group">
						<div class="row">
							...
							<input type="hidden" name="idSis_Empresa" value="<?php #echo $parcelaspag['idSis_Empresa']; ?>">-->
							<?php if ($metodo > 1) { ?>
							<!--<input type="hidden" name="idApp_Procedimento" value="<?php# echo $procedimento['idApp_Procedimento']; ?>">
							<input type="hidden" name="idApp_ParcelasPagaveis" value="<?php echo $parcelaspag['idApp_ParcelasPagaveis']; ?>">-->
							<?php } ?>
							<?php if ($metodo == 2) { ?>
