			...
			<div class="form-group">
				<div class="row">
					<div class="col-md-12">
						...
						<?php echo form_open('agendacli', 'role="form"'); ?>
							<div class="col-md-12">
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<strong><span class="glyphicon glyphicon-pencil"></span> Tarefas  
				<a class="btn btn-sm btn-info" href="<?php echo base_url() ?>relatoriocli/procedimento" role="button">
					<span class="glyphicon glyphicon-search"></span> Pesq.
				</a>
				<a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>procedimentocli/cadastrar" role="button">
