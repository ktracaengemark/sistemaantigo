										...
										<div class="tab-content">
											...
											<div role="tabpanel" class="tab-pane active " id="proxima">
												...
												<div class="bs-callout bs-callout-success" id=callout-overview-not-both>
													...
													<a class="btn btn-success" href="<?php echo base_url() . 'procedcli/alterar/' . $row['idApp_ProcedimentoCli'] ?>" role="button">
														<span class="glyphicon glyphicon-edit"></span> Editar Dados
													</a>
													
													<!--	
													<a class="btn btn-md btn-info" target="_blank" href="<?php echo base_url() . 'OrcatrataPrint/imprimir/' . $row['idApp_ProcedimentoCli']; ?>" role="button">
													...
													<h4>
														<span class="glyphicon glyphicon-tags"></span> <b>Nº Orç.:</b> <?php echo $row['idApp_ProcedimentoCli']; ?>
													</h4>
													<br>
													<p>
											...
											<div role="tabpanel" class="tab-pane " id="anterior">
												...
												<div class="bs-callout bs-callout-danger" id=callout-overview-not-both>
													...
													<a class="btn btn-danger" href="<?php echo base_url() . 'procedcli/alterar/' . $row['idApp_ProcedimentoCli'] ?>" role="button">
														<span class="glyphicon glyphicon-edit"></span> Editar Dados
													</a>
													<!--
													<a class="btn btn-md btn-info" target="_blank" href="<?php echo base_url() . 'OrcatrataPrint/imprimir/' . $row['idApp_ProcedimentoCli']; ?>" role="button">
