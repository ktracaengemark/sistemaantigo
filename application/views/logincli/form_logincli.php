<div class="container text-center" id="login">
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit">Conta Pessoal</button>	
    <br>
	<p><a href="<?php echo base_url(); ?>logincli/recuperar/?usuario=<?php echo set_value('Usuario'); ?>">Esqueci usuário/senha!</a></p>
    <br>
	...
	<a class="btn btn btn-primary btn-danger btn-block" href="<?php echo base_url(); ?>loginempresa/registrar" role="button">Cad. Nova Empresa</a>	
	<a class="btn btn btn-primary btn-danger btn-block" href="<?php echo base_url(); ?>logincli/registrar" role="button">Cad. Conta Pessoal</a>
