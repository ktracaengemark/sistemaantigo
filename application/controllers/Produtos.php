...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if ($id) {
			...
			*/
            ...
            #### Tab_Valor ####
            $data['item_promocao'] = $this->Produtos_model->get_item_promocao($id, "1");
		...
		*/
        ...
        if ($this->form_validation->run() === FALSE) {
			...
			*/
            #### Tab_Valor ####
            $data['update']['item_promocao']['anterior'] = $this->Produtos_model->get_item_promocao($data['produtos']['idTab_Produtos'], "1");
