...
*/
    ...
    public function alterarlogo($id = FALSE) {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $config['upload_path'] = 'arquivos/imagens/empresas/' . $_SESSION['Empresa']['idSis_Empresa'] . '/produtos/original/';
            ...
            if (!$this->upload->do_upload('Arquivo')) {
				...
				$dir = 'arquivos/imagens/empresas/' . $_SESSION['Empresa']['idSis_Empresa'] . '/produtos/original/';		
				$foto = $data['file']['Arquivo'];
				$diretorio = $dir.$foto;					
				$dir2 = 'arquivos/imagens/empresas/' . $_SESSION['Empresa']['idSis_Empresa'] . '/produtos/miniatura/';
