            ...
            */			
            ...
            if (isset($data['servico'])) {
                ...
                for($j=1;$j<=$max;$j++) {
					...
					$data['servico'][$j]['idApp_Cliente'] = $data['query']['idApp_Cliente'];
            ...
            if (isset($data['produto'])) {
                ...
                for($j=1;$j<=$max;$j++) {
					...
					$data['produto'][$j]['idApp_Cliente'] = $data['query']['idApp_Cliente'];
            ...
            if (isset($data['parcelasrec'])) {
                ...
                for($j=1;$j<=$max;$j++) {
					...
					$data['parcelasrec'][$j]['idApp_Cliente'] = $data['query']['idApp_Cliente'];
            ...
            if (isset($data['procedimento'])) {
                ...
                for($j=1;$j<=$max;$j++) {
					...
					$data['procedimento'][$j]['idApp_Cliente'] = $data['query']['idApp_Cliente'];
            ...
            */			
            ...
            if (isset($data['servico']) || (!isset($data['servico']) && isset($data['update']['servico']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    ...
                    $data['update']['servico']['inserir'][$j]['idApp_Cliente'] = $data['query']['idApp_Cliente'];					
            ...
            if (isset($data['produto']) || (!isset($data['produto']) && isset($data['update']['produto']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    ...
                    $data['update']['produto']['inserir'][$j]['idApp_Cliente'] = $data['query']['idApp_Cliente'];
            ...
            if (isset($data['parcelasrec']) || (!isset($data['parcelasrec']) && isset($data['update']['parcelasrec']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    ...
                    $data['update']['parcelasrec']['inserir'][$j]['idApp_Cliente'] = $data['query']['idApp_Cliente'];
        ...
        */
        ...
        if ($this->form_validation->run() === FALSE) {
            if ($data['orcatrata']['Tipo_Orca']= 'B' ){
				...
				$this->load->view('orcatrata/form_orcatrataalteraronline', $data);
			}
		} else {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if ($id) {
			...
			$data['online']['NomeCliente'] = $this->Basico_model->get_cliente($data['orcatrata']['idApp_Cliente'], TRUE);
			$data['online']['TipoFinanceiro'] = $this->Basico_model->get_tipofinanceiro($data['orcatrata']['TipoFinanceiro']);
			$data['online']['Descricao'] = $data['orcatrata']['Descricao'];
			$data['online']['AVAP'] = $this->Basico_model->get_avap($data['orcatrata']['AVAP']);
			$data['online']['Modalidade'] = $this->Basico_model->get_modalidade($data['orcatrata']['Modalidade']);
			$data['online']['FormaPagamento'] = $this->Basico_model->get_formapagamento($data['orcatrata']['FormaPagamento']);
			$data['online']['ValorOrca'] = $data['orcatrata']['ValorOrca'];
			$data['online']['ValorDev'] = $data['orcatrata']['ValorDev'];
			$data['online']['ValorRestanteOrca'] = $data['orcatrata']['ValorRestanteOrca'];
			$data['online']['DataOrca'] = $data['orcatrata']['DataOrca'];
			$data['online']['DataVencimentoOrca'] = $data['orcatrata']['DataVencimentoOrca'];
			$data['online']['QtdParcelasOrca'] = $data['orcatrata']['QtdParcelasOrca'];
            #### App_Servico ####
            $data['servico'] = $this->Orcatrata_model->get_servico($id);
            if (count($data['servico']) > 0) {
                $data['servico'] = array_combine(range(1, count($data['servico'])), array_values($data['servico']));
        ...
        $data['titulo'] = 'Editar Pedido Online';
        ...
        $data['radio'] = array(
            'EnviadoOrca' => $this->basico->radio_checked($data['orcatrata']['EnviadoOrca'], 'Produtos Devolvidos', 'NS'),
        );
        ($data['orcatrata']['EnviadoOrca'] == 'S') ?
        ...
        */
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data['orcatrata']['ValorOrca'] = $data['orcatrata']['ValorOrca'];
            $data['orcatrata']['ValorDev'] = $data['orcatrata']['ValorDev'];
			$data['orcatrata']['ValorEntradaOrca'] = $data['orcatrata']['ValorEntradaOrca'];
			$data['orcatrata']['ValorDinheiro'] = $data['orcatrata']['ValorDinheiro'];
			$data['orcatrata']['ValorTroco'] = $data['orcatrata']['ValorTroco'];
            $data['orcatrata']['ValorRestanteOrca'] = $data['orcatrata']['ValorRestanteOrca'];            
			$data['orcatrata']['DataEntradaOrca'] = $this->basico->mascara_data($data['orcatrata']['DataEntradaOrca'], 'mysql');
			#$data['orcatrata']['idTab_TipoRD'] = $data['orcatrata']['idTab_TipoRD'];
			#$data['orcatrata']['idSis_Empresa'] = $_SESSION['log']['idSis_Empresa'];
            #$data['orcatrata']['idSis_Usuario'] = $_SESSION['log']['idSis_Usuario'];
            ...
            if (isset($data['servico']) || (!isset($data['servico']) && isset($data['update']['servico']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    ...
                    $data['update']['servico']['inserir'][$j]['idSis_Usuario'] = $data['orcatrata']['idSis_Usuario'];
                    $data['update']['servico']['inserir'][$j]['idSis_Empresa'] = $data['orcatrata']['idSis_Empresa'];
					$data['update']['servico']['inserir'][$j]['idTab_Modulo'] = $data['orcatrata']['idTab_Modulo'];
                    $data['update']['servico']['inserir'][$j]['idApp_OrcaTrata'] = $data['orcatrata']['idApp_OrcaTrata'];
                    $data['update']['servico']['inserir'][$j]['idApp_Cliente'] = $data['orcatrata']['idApp_Cliente'];				
					$data['update']['servico']['inserir'][$j]['idTab_TipoRD'] = "4";
					$data['update']['servico']['inserir'][$j]['DataValidadeServico'] = $this->basico->mascara_data($data['update']['servico']['inserir'][$j]['DataValidadeServico'], 'mysql');
            ...
            if (isset($data['produto']) || (!isset($data['produto']) && isset($data['update']['produto']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    /*
					if ($data['update']['produto']['inserir'][$j]['idSis_Usuario']) {
						$data['update']['produto']['inserir'][$j]['idSis_Usuario'] = $data['update']['produto']['inserir'][$j]['idSis_Usuario'];
					}else {
						$data['update']['produto']['inserir'][$j]['idSis_Usuario'] = $data['orcatrata']['idSis_Usuario'];
					}
					*/
					$data['update']['produto']['inserir'][$j]['idSis_Usuario'] = $data['orcatrata']['idSis_Usuario'];
                    $data['update']['produto']['inserir'][$j]['idSis_Empresa'] = $data['orcatrata']['idSis_Empresa'];
					$data['update']['produto']['inserir'][$j]['idTab_Modulo'] = $data['orcatrata']['idTab_Modulo'];
                    $data['update']['produto']['inserir'][$j]['idApp_OrcaTrata'] = $data['orcatrata']['idApp_OrcaTrata'];
                    $data['update']['produto']['inserir'][$j]['idApp_Cliente'] = $data['orcatrata']['idApp_Cliente'];
					$data['update']['produto']['inserir'][$j]['idTab_TipoRD'] = "2";
					$data['update']['produto']['inserir'][$j]['DataValidadeProduto'] = $this->basico->mascara_data($data['update']['produto']['inserir'][$j]['DataValidadeProduto'], 'mysql');
                ...
                for($j=0;$j<$max;$j++) {
					...
					if ($data['orcatrata']['AprovadoOrca'] == 'S') { 
						...
						$data['update']['produto']['alterar'][$j]['ConcluidoProduto'] = 'N';
						$data['update']['produto']['alterar'][$j]['DevolvidoProduto'] = 'N';
					}
					if ($data['orcatrata']['idApp_Cliente']) $data['update']['produto']['alterar'][$j]['idApp_Cliente'] = $data['orcatrata']['idApp_Cliente'];					
                }
            ...
            if (isset($data['parcelasrec']) || (!isset($data['parcelasrec']) && isset($data['update']['parcelasrec']['anterior']) ) ) {
                ...
                $max = count($data['update']['parcelasrec']['inserir']);
                for($j=0;$j<$max;$j++) {
                    $data['update']['parcelasrec']['inserir'][$j]['idSis_Usuario'] = $data['orcatrata']['idSis_Usuario'];
                    $data['update']['parcelasrec']['inserir'][$j]['idSis_Empresa'] = $data['orcatrata']['idSis_Empresa'];
					$data['update']['parcelasrec']['inserir'][$j]['idTab_Modulo'] = $data['orcatrata']['idTab_Modulo'];
                    $data['update']['parcelasrec']['inserir'][$j]['idApp_OrcaTrata'] = $data['orcatrata']['idApp_OrcaTrata'];
                    $data['update']['parcelasrec']['inserir'][$j]['idApp_Cliente'] = $data['orcatrata']['idApp_Cliente'];
					$data['update']['parcelasrec']['inserir'][$j]['idTab_TipoRD'] = "2";
                    $data['update']['parcelasrec']['inserir'][$j]['ValorParcela'] = str_replace(',', '.', str_replace('.', '', $data['update']['parcelasrec']['inserir'][$j]['ValorParcela']));
            ...
            if (isset($data['procedimento']) || (!isset($data['procedimento']) && isset($data['update']['procedimento']['anterior']) ) ) {
                ...
                $max = count($data['update']['procedimento']['inserir']);
                for($j=0;$j<$max;$j++) {
                    $data['update']['procedimento']['inserir'][$j]['idSis_Usuario'] = $data['orcatrata']['idSis_Usuario'];
                    $data['update']['procedimento']['inserir'][$j]['idSis_Empresa'] = $data['orcatrata']['idSis_Empresa'];
					$data['update']['procedimento']['inserir'][$j]['idTab_Modulo'] = $data['orcatrata']['idTab_Modulo'];
                    $data['update']['procedimento']['inserir'][$j]['idApp_OrcaTrata'] = $data['orcatrata']['idApp_OrcaTrata'];
                    $data['update']['procedimento']['inserir'][$j]['idApp_Cliente'] = $data['orcatrata']['idApp_Cliente'];
					$data['update']['procedimento']['inserir'][$j]['DataProcedimento'] = $this->basico->mascara_data($data['update']['procedimento']['inserir'][$j]['DataProcedimento'], 'mysql');
					$data['update']['procedimento']['inserir'][$j]['DataProcedimentoLimite'] = $this->basico->mascara_data($data['update']['procedimento']['inserir'][$j]['DataProcedimentoLimite'], 'mysql');
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if (isset($data['servico']) || (!isset($data['servico']) && isset($data['update']['servico']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
					...
					$data['update']['servico']['alterar'][$j]['ValorServico'] = str_replace(',', '.', str_replace('.', '', $data['update']['servico']['alterar'][$j]['ValorServico']));
                    unset($data['update']['servico']['alterar'][$j]['SubtotalServico']);
					if ($data['query']['Entregues'] == 'S') $data['update']['servico']['alterar'][$j]['ConcluidoServico'] = 'S';
