...
class Orcatrata extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Orcatrata_model', 'Procedimento_model', 'Pedidos_model', 'Produtos_model', 'Usuario_model', 'Cliente_model', 'Fornecedor_model', 'Relatorio_model', 'Formapag_model'));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if ($id) {
		  ...
		  */
			...
			echo '<br>';
			print_r($_SESSION['Cliente']['idApp_Cliente']);
			echo "</pre>";
			exit ();			       
			*/
            ...
            */			
            ...
            if (isset($data['servico']) || (!isset($data['servico']) && isset($data['update']['servico']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
					...
					echo '<br>';
					echo "<pre>";
					print_r($qtd_anterior[$j]);
					echo '<br>';
					print_r($qtd_atual[$j]);
					echo '<br>';
					print_r($diff_estoque[$j]);
					echo "</pre>";
					*/
