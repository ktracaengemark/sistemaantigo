...
class Loginmatriz extends CI_Controller {
    ...
    public function index() {
        ...
        $this->form_validation->set_rules('UsuarioMatriz', 'Usuário', 'required|trim|callback_valid_usuario');
    ...
    public function registrar() {
        ...
        $this->form_validation->set_rules('UsuarioMatriz', 'Usuário', 'required|trim|is_unique[Sis_UsuarioMatriz.UsuarioMatriz]');
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($data['idSis_UsuarioMatriz'] === FALSE) {
                ...
                $this->email->subject('[KTRACA] Confirmação de registro - Usuário: ' . $data['query']['UsuarioMatriz']);
    ...
    public function recuperar() {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($this->Loginmatriz_model->troca_senha($id['idSis_UsuarioMatriz'], array('Codigo' => $data['query']['Codigo'])) === FALSE) {
                ...
                $this->email->subject('[KTRACA] Alteração de Senha - Usuário: ' . $data['query']['UsuarioMatriz']);
