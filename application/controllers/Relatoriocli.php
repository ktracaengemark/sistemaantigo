...
class Relatoriocli extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Profissional_model', 'Cliente_model', 'Relatoriocli_model'));
    ...
    public function financeiro() {
		...
		$data['select']['NomeCliente'] = $this->Relatoriocli_model->select_cliente();
        ...
        */
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_financeiro($data['bd'],TRUE);
...
*/
		...
		$data['select']['NomeCliente'] = $this->Relatoriocli_model->select_cliente();
		$data['select']['NomeEmpresa'] = $this->Relatoriocli_model->select_empresas();
		$data['select']['TipoReceita'] = $this->Relatoriocli_model->select_tiporeceita();
		$data['select']['Mesvenc'] = $this->Relatoriocli_model->select_mes();
		$data['select']['Mespag'] = $this->Relatoriocli_model->select_mes();
		/*
        $data['select']['Pesquisa'] = array(
            'DataEntradaOrca' => 'Data de Entrada',
            'DataVencimentoRecebiveis' => 'Data de Vencimento da Parcela',
        ...
        */
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_receitas($data['bd'],TRUE);
	...
	public function despesas1() {
		...
		*/
		...
		$data['select']['TipoDespesa'] = $this->Relatoriocli_model->select_tipodespesa();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_despesas($data['bd'],TRUE);
	...
	public function despesaspag() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_despesaspag($data['bd'],TRUE);
	...
	public function devolucao1DESPESAS() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_devolucao($data['bd'],TRUE);
    ...
    public function balanco() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_balanco($data['query']);
    ...
    public function estoque() {
        ...
        $data['select']['Produtos'] = $this->Relatoriocli_model->select_produtos();
		$data['select']['Prodaux1'] = $this->Relatoriocli_model->select_prodaux1();
		$data['select']['Prodaux2'] = $this->Relatoriocli_model->select_prodaux2();
		$data['select']['Prodaux3'] = $this->Relatoriocli_model->select_prodaux3();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_estoque($data['bd']);
	...
	$data['select']['NomeCliente'] = $this->Relatoriocli_model->select_cliente();
	$data['select']['idApp_Cliente'] = $this->Relatoriocli_model->select_cliente();
	...
	if ($this->form_validation->run() !== FALSE) {
		...
		$data['report'] = $this->Relatoriocli_model->list_rankingvendas($data['bd']);
	...
	public function produtosvend() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['bd']['Campo'] = $data['query']['Campo'];
			$data['bd']['AprovadoOrca'] = $data['query']['AprovadoOrca'];
            $data['report'] = $this->Relatoriocli_model->list_produtosvend($data['bd'],TRUE);
	...
	public function produtosdevol1() {
		...
		$data['select']['NomeCliente'] = $this->Relatoriocli_model->select_cliente();
		$data['select']['TipoDevolucao'] = $this->Relatoriocli_model->select_tipodevolucao();
		$data['select']['Produtos'] = $this->Relatoriocli_model->select_produtos();
		$data['select']['Prodaux1'] = $this->Relatoriocli_model->select_prodaux1();
		$data['select']['Prodaux2'] = $this->Relatoriocli_model->select_prodaux2();
		$data['select']['Prodaux3'] = $this->Relatoriocli_model->select_prodaux3();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_produtosdevol1($data['bd'],TRUE);
	...
	public function servicosprest1() {
		...
		$data['select']['NomeCliente'] = $this->Relatoriocli_model->select_cliente();
		$data['select']['NomeProfissional'] = $this->Relatoriocli_model->select_profissional();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_servicosprest($data['bd'],TRUE);
	...
	public function consumo() {
		...
		$data['select']['TipoDespesa'] = $this->Relatoriocli_model->select_tipoconsumo();
		$data['select']['Produtos'] = $this->Relatoriocli_model->select_produtos();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_consumo($data['bd'],TRUE);
	...
	public function produtoscomp() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_produtoscomp($data['bd'],TRUE);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_produtosdevol($data['bd'],TRUE);
    ...
    public function orcamento() {
		...
		*/
        ...
        $data['select']['NomeCliente'] = $this->Relatoriocli_model->select_cliente();
		$data['select']['FormaPag'] = $this->Relatoriocli_model->select_formapag();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_orcamento($data['bd'],TRUE);
	...
	public function devolucao1() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_devolucao1($data['bd'],TRUE);
	...
	public function despesas() {
		...
		*/
        ...
        $data['select']['NomeCliente'] = $this->Relatoriocli_model->select_cliente();
		$data['select']['TipoDespesa'] = $this->Relatoriocli_model->select_tipodespesa();
		$data['select']['Categoriadesp'] = $this->Relatoriocli_model->select_categoriadesp();
    ...
    public function clientes() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_clientes($data['bd'],TRUE);
	...
	public function associado() {
        ...
        $data['select']['Nome'] = $this->Relatoriocli_model->select_associado();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_associado($data['bd'],TRUE);
	...
	public function empresaassociado() {
        ...
        $data['select']['NomeEmpresa'] = $this->Relatoriocli_model->select_empresaassociado();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_empresaassociado($data['bd'],TRUE);
	...
	public function profissionais() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_profissionais($data['bd'],TRUE);
	...
	public function funcionario() {
        ...
        $data['select']['Nome'] = $this->Relatoriocli_model->select_funcionario();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_funcionario($data['bd'],TRUE);
	...
	public function empresas() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_empresas($data['bd'],TRUE);
	...
	public function fornecedor() {
        ...
        $data['select']['NomeFornecedor'] = $this->Relatoriocli_model->select_fornecedor();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_fornecedor($data['bd'],TRUE);
	...
	public function produtos() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_produtos($data['bd'],TRUE);
	...
	public function servicos() {
        ...
        $data['select']['Servicos'] = $this->Relatoriocli_model->select_servicos();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_servicos($data['bd'],TRUE);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_orcamentopc($data['bd'],TRUE);
...
*/
        ...
        $data['select']['NomeProfissional'] = $this->Relatoriocli_model->select_profissional3();
		$data['select']['Profissional'] = $this->Relatoriocli_model->select_profissional2();
		$data['select']['ObsTarefa'] = $this->Relatoriocli_model->select_obstarefa();
		$data['select']['Procedtarefa'] = $this->Relatoriocli_model->select_procedtarefa();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_tarefa($data['bd'],TRUE);
	...
	public function clienteprod() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_clienteprod($data['bd'],TRUE);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_orcamentosv($data['bd'],TRUE);
    ...
    public function procedimento() {
        ...
        #$data['select']['NomeCliente'] = $this->Relatoriocli_model->select_cliente();
		$data['select']['Dia'] = $this->Relatoriocli_model->select_dia();
		$data['select']['Mesvenc'] = $this->Relatoriocli_model->select_mes();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriocli_model->list_procedimento($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriocli/list_procedimento', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriocli/tela_procedimento', $data);
