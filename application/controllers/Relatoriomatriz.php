...
class Relatoriomatriz extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Profissional_model', 'Cliente_model', 'Relatoriomatriz_model'));
        ...
        #$this->load->view('relatoriomatriz/nav_secundario');
    }
    ...
    public function index() {
        ...
        $this->load->view('relatoriomatriz/tela_index', $data);
    ...
    public function financeiro() {
		...
		$data['select']['NomeEmpresa'] = $this->Relatoriomatriz_model->select_cliente();
        ...
        */
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_financeiro($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_financeiro', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_financeiro', $data);
...
*/
		...
		$data['select']['NomeEmpresa'] = $this->Relatoriomatriz_model->select_empresa();
		$data['select']['TipoReceita'] = $this->Relatoriomatriz_model->select_tiporeceita();
		$data['select']['Mesvenc'] = $this->Relatoriomatriz_model->select_mes();
		$data['select']['Mespag'] = $this->Relatoriomatriz_model->select_mes();
		/*
        $data['select']['Pesquisa'] = array(
            'DataEntradaOrca' => 'Data de Entrada',
            'DataVencimentoRecebiveis' => 'Data de Vencimento da Parcela',
        ...
        */
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_receitas($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_receitas', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_receitas', $data);

        $this->load->view('basico/footer');

    }

	public function receitas2() {
	...
	public function despesas1() {
		...
		*/
		...
		$data['select']['TipoDespesa'] = $this->Relatoriomatriz_model->select_tipodespesa();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_despesas($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_despesas', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_despesas', $data);
	...
	public function despesaspag() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_despesaspag($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_despesaspag', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_despesaspag', $data);
	...
	public function devolucao1DESPESAS() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_devolucao($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_devolucao', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_devolucao', $data);
    ...
    public function balanco() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_balanco($data['query']);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_balanco', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_balanco', $data);
    ...
    public function estoque() {
        ...
        $data['select']['Produtos'] = $this->Relatoriomatriz_model->select_produtos();
		$data['select']['Prodaux1'] = $this->Relatoriomatriz_model->select_prodaux1();
		$data['select']['Prodaux2'] = $this->Relatoriomatriz_model->select_prodaux2();
		$data['select']['idTab_Catprod'] = $this->Relatoriomatriz_model->select_prodaux3();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_estoque($data['bd']);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_estoque', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_estoque', $data);
	...
	$data['select']['NomeEmpresa'] = $this->Relatoriomatriz_model->select_cliente();
	$data['select']['idApp_Cliente'] = $this->Relatoriomatriz_model->select_cliente();
	...
	if ($this->form_validation->run() !== FALSE) {
		...
		$data['report'] = $this->Relatoriomatriz_model->list_rankingvendas($data['bd']);
		...
		$data['list'] = $this->load->view('relatoriomatriz/list_rankingvendas', $data, TRUE);
		//$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
	}

	$this->load->view('relatoriomatriz/tela_rankingvendas', $data);
	...
	public function admin() {
        ...
        $this->load->view('relatoriomatriz/tela_admin', $data);
	...
	public function adminempresa() {
        ...
        $this->load->view('relatoriomatriz/tela_adminempresa', $data);
	...
	public function sistema() {
        ...
        $this->load->view('relatoriomatriz/tela_sistema', $data);
	...
	public function produtosvend() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['bd']['Campo'] = $data['query']['Campo'];
			$data['bd']['AprovadoOrca'] = $data['query']['AprovadoOrca'];
            $data['report'] = $this->Relatoriomatriz_model->list_produtosvend($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_produtosvend', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_produtosvend', $data);
	...
	public function produtosdevol1() {
		...
		$data['select']['NomeEmpresa'] = $this->Relatoriomatriz_model->select_cliente();
		$data['select']['TipoDevolucao'] = $this->Relatoriomatriz_model->select_tipodevolucao();
		$data['select']['Produtos'] = $this->Relatoriomatriz_model->select_produtos();
		$data['select']['Prodaux1'] = $this->Relatoriomatriz_model->select_prodaux1();
		$data['select']['Prodaux2'] = $this->Relatoriomatriz_model->select_prodaux2();
		$data['select']['idTab_Catprod'] = $this->Relatoriomatriz_model->select_prodaux3();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_produtosdevol1($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_produtosdevol1', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_produtosdevol1', $data);
	...
	public function servicosprest1() {
		...
		$data['select']['NomeEmpresa'] = $this->Relatoriomatriz_model->select_cliente();
		$data['select']['NomeProfissional'] = $this->Relatoriomatriz_model->select_profissional();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_servicosprest($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_servicosprest', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_servicosprest', $data);
	...
	public function consumo() {
		...
		$data['select']['TipoDespesa'] = $this->Relatoriomatriz_model->select_tipoconsumo();
		$data['select']['Produtos'] = $this->Relatoriomatriz_model->select_produtos();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_consumo($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_consumo', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_consumo', $data);
	...
	public function produtoscomp() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_produtoscomp($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_produtoscomp', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_produtoscomp', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_produtosdevol($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_produtosdevol', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_produtosdevol', $data);
    ...
    public function orcamento() {
		...
		*/
        ...
        $data['select']['NomeEmpresa'] = $this->Relatoriomatriz_model->select_cliente();
		$data['select']['FormaPag'] = $this->Relatoriomatriz_model->select_formapag();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_orcamento($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_orcamento', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_orcamento', $data);
	...
	public function devolucao1() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_devolucao1($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_devolucao1', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_devolucao1', $data);
	...
	public function despesas() {
		...
		*/
        ...
        $data['select']['NomeEmpresa'] = $this->Relatoriomatriz_model->select_cliente();
		$data['select']['TipoDespesa'] = $this->Relatoriomatriz_model->select_tipodespesa();
		$data['select']['Categoriadesp'] = $this->Relatoriomatriz_model->select_categoriadesp();
    ...
    public function clientes() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_clientes($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_clientes', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_clientes', $data);
	...
	public function associado() {
        ...
        $data['select']['Nome'] = $this->Relatoriomatriz_model->select_associado();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_associado($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_associado', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_associado', $data);
	...
	public function empresaassociado() {
        ...
        $data['select']['NomeEmpresa'] = $this->Relatoriomatriz_model->select_empresaassociado();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_empresaassociado($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_empresaassociado', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_empresaassociado', $data);
	...
	public function profissionais() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_profissionais($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_profissionais', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_profissionais', $data);
	...
	public function funcionario() {
        ...
        $data['select']['Nome'] = $this->Relatoriomatriz_model->select_funcionario();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_funcionario($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_funcionario', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_funcionario', $data);
	...
	public function empresas() {
        ...
        $data['select']['NomeEmpresa'] = $this->Relatoriomatriz_model->select_empresas();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_empresas($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_empresas', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_empresas', $data);
	...
	public function fornecedor() {
        ...
        $data['select']['NomeFornecedor'] = $this->Relatoriomatriz_model->select_fornecedor();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_fornecedor($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_fornecedor', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_fornecedor', $data);
	...
	public function produtos() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_produtos($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_produtos', $data, TRUE);

        }

        $this->load->view('relatoriomatriz/tela_produtos', $data);
	...
	public function servicos() {
        ...
        $data['select']['Servicos'] = $this->Relatoriomatriz_model->select_servicos();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_servicos($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_servicos', $data, TRUE);

        }

        $this->load->view('relatoriomatriz/tela_servicos', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_orcamentopc($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_orcamentopc', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_orcamentopc', $data);
...
*/
        ...
        $data['select']['NomeProfissional'] = $this->Relatoriomatriz_model->select_profissional3();
		$data['select']['Profissional'] = $this->Relatoriomatriz_model->select_profissional2();
		$data['select']['ObsTarefa'] = $this->Relatoriomatriz_model->select_obstarefa();
		$data['select']['Procedtarefa'] = $this->Relatoriomatriz_model->select_procedtarefa();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_tarefa($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_tarefa', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_tarefa', $data);
	...
	public function clienteprod() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_clienteprod($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_clienteprod', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_clienteprod', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriomatriz_model->list_orcamentosv($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriomatriz/list_orcamentosv', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriomatriz/tela_orcamentosv', $data);
