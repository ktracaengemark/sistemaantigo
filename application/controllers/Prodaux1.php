...
class Prodaux1 extends CI_Controller {
    ...
    public function cadastrar($tabela = NULL) {
        ...
        $data['titulo'] = 'Cadastrar Aux1';
        $data['form_open_path'] = 'prodaux1/cadastrar';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 1;
        ...
        $data['list'] = $this->load->view('prodaux1/list_prodaux1', $data, TRUE);

        #run form validation
        if ($this->form_validation->run() === FALSE) {
            $this->load->view('prodaux1/pesq_prodaux1', $data);
        } else {
           ...
           # $data['query']['ValorVenda'] = str_replace(',','.',str_replace('.','',$data['query']['ValorVenda']));
            ...
            if ($data['idTab_Prodaux1'] === FALSE) {
                ...
                $this->load->view('prodaux1/cadastrar', $data);
            } else {
                ...
                redirect(base_url() . 'prodaux1/cadastrar' . $data['msg']);
                exit();
            }
        }
    ...
    public function cadastrar3($tabela = NULL) {
        ...
        $data['form_open_path'] = 'prodaux1/cadastrar3';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 1;
        ...
        if ($this->form_validation->run() === FALSE) {
           ...
           # $data['query']['ValorVenda'] = str_replace(',','.',str_replace('.','',$data['query']['ValorVenda']));
            ...
            if ($data['idTab_Prodaux1'] === FALSE) {
                ...
                redirect(base_url() . 'prodaux1/cadastrar3' . $data['msg']);
                exit();
            }
        }
    ...
    public function alterar($id = FALSE) {
       ...
       # $this->form_validation->set_rules('ValorVenda', 'Valor do Convênio', 'required|trim');
        ...
        $data['titulo'] = 'Editar Aux1';
        $data['form_open_path'] = 'prodaux1/alterar';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 2;
        ...
        if ($this->form_validation->run() === FALSE) {
           ...
           # $data['query']['ValorVenda'] = str_replace(',','.',str_replace('.','',$data['query']['ValorVenda']));
            ...
            if ($data['auditoriaitem'] && $this->Prodaux1_model->update_prodaux1($data['query'], $data['query']['idTab_Prodaux1']) === FALSE) {
                $data['msg'] = '?m=2';
                redirect(base_url() . 'prodaux1/alterar/' . $data['query']['idApp_Cliente'] . $data['msg']);
                exit();
            } else {
    ...
    public function alterar3($id = FALSE) {
       ...
       # $this->form_validation->set_rules('ValorVenda', 'Valor do Convênio', 'required|trim');
        ...
        $data['form_open_path'] = 'prodaux1/alterar3';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 2;
        ...
        if ($this->form_validation->run() === FALSE) {
           ...
           # $data['query']['ValorVenda'] = str_replace(',','.',str_replace('.','',$data['query']['ValorVenda']));
            ...
            if ($data['auditoriaitem'] && $this->Prodaux1_model->update_prodaux1($data['query'], $data['query']['idTab_Prodaux1']) === FALSE) {
                $data['msg'] = '?m=2';
                redirect(base_url() . 'prodaux1/alterar3/' . $data['msg']);
                exit();
            } else {
