...
class OrcatrataPrint extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Orcatrata_model', 'OrcatrataPrint_model', 'Orcatrataprintcobranca_model', 'Relatorio_model', 'Formapag_model' , 'Usuario_model' , 'Cliente_model' , 'Fornecedor_model'));
