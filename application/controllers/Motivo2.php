...
class Motivo2 extends CI_Controller {
    ...
    public function cadastrar3($tabela = NULL) {
        ...
        $data['form_open_path'] = 'motivo2/cadastrar3';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 1;
        ...
        $data['list'] = $this->load->view('motivo/list_motivo33', $data, TRUE);

        #run form validation
        if ($this->form_validation->run() === FALSE) {
            $this->load->view('motivo/pesq_motivo33', $data);
        } else {
            ...
            if ($data['idTab_Motivo'] === FALSE) {
                ...
                $this->load->view('motivo/cadastrar3', $data);
            } else {
                ...
                redirect(base_url() . 'motivo2/cadastrar3' . $data['msg']);
                exit();
            }
        }
    ...
    public function alterar3($id = FALSE) {
        ...
        $data['form_open_path'] = 'motivo2/alterar3';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 2;
