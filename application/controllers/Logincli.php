...
class Logincli extends CI_Controller {
    ...
    public function index() {
        ...
        elseif ($this->input->get('m') == 3)
            $data['msg'] = $this->basico->msg('<strong>Sua sessão expirou. Faça o logincli novamente.</strong>', 'erro', TRUE, TRUE, TRUE);
        elseif ($this->input->get('m') == 4)
            $data['msg'] = $this->basico->msg('<strong>Usuário ativado com sucesso! Faça o logincli para acessar o sistema.</strong>', 'sucesso', TRUE, TRUE, TRUE);
