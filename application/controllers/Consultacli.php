...
class Consultacli extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Profissional_model', 'Consultacli_model', 'Empresafilial_model', 'Cliente_model'));
...
*/
		...
		$data['select']['idApp_Agenda'] = $this->Basico_model->select_agendacli();
		...
		#$data['select']['ContatoCliente'] = $this->Consultacli_model->select_contatocliente_cliente($data['query']['idApp_Cliente']);
...
*/
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data['idApp_Consulta'] = $this->Consultacli_model->set_consulta($data['query']);
            ...
            if ($data['idApp_Consulta'] === FALSE) {
                ...
                $data['auditoria'] = $this->Basico_model->set_auditoriacli($data['auditoriaitem'], 'App_Consulta', 'CREATE', $data['auditoriaitem']);
                $data['msg'] = '?m=1';
...
*/
    ...
    public function alterar($idApp_Cliente = FALSE, $idApp_Consulta = FALSE) {
        ...
        if ($idApp_Consulta) {
            $data['query']['idApp_Cliente'] = $idApp_Cliente;
            $data['query'] = $this->Consultacli_model->get_consulta($idApp_Consulta);
        ...
        $data['titulo'] = 'Agendamento C/ Cliente';
        $data['form_open_path'] = 'consultacli/alterar';
        #$data['readonly'] = '';
        #$data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 2;
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data['anterior'] = $this->Consultacli_model->get_consulta($data['query']['idApp_Consulta']);
            $data['campos'] = array_keys($data['query']);
            ...
            if ($data['auditoriaitem'] && $this->Consultacli_model->update_consulta($data['query'], $data['query']['idApp_Consulta']) === FALSE) {
                $data['msg'] = '?m=2';
                ...
                if ($data['auditoriaitem'] === FALSE) {
                    ...
                    $data['auditoria'] = $this->Basico_model->set_auditoriacli($data['auditoriaitem'], 'App_Consulta', 'UPDATE', $data['auditoriaitem']);
                    $data['msg'] = '?m=1';
                }
    ...
    public function listar($idApp_Cliente = NULL) {
        ...
        $data['query'] = array();
        $data['proxima'] = $this->Consultacli_model->lista_consulta_proxima($idApp_Cliente);
        $data['anterior'] = $this->Consultacli_model->lista_consulta_anterior($idApp_Cliente);
    ...
    public function excluir($id = FALSE) {
        ...
        if (!$id) {
            ...
            $data['anterior'] = $this->Consultacli_model->get_consulta($id);
            #$data['campos'] = array_keys($data['query']);
            ...
            $data['auditoria'] = $this->Basico_model->set_auditoriacli($data['auditoriaitem'], 'App_Consulta', 'DELETE', $data['auditoriaitem']);

            $this->Consultacli_model->delete_consulta($id);
    ...
    public function cadastrar_evento($idApp_Cliente = NULL, $idApp_Agenda = NULL) {
        ...
        $data['form_open_path'] = 'consultacli/cadastrar_evento';
        $data['panel'] = 'primary';
        $data['metodo'] = 1;
        $data['evento'] = 1;
        ...
        #run form validation
        if ($this->form_validation->run() === FALSE) {
            $this->load->view('consultacli/form_eventocli', $data);
        } else {
            ...
            if ($data['idApp_Consulta'] === FALSE) {
                ...
                $this->basico->erro($msg);
                $this->load->view('consultacli/form_consultacli', $data);
            } else {
                ...
                //redirect(base_url() . 'cliente/prontuario/' . $data['query']['idApp_Cliente'] . $data['msg'] . $data['redirect']);
                redirect(base_url() . 'agendacli' . $data['msg'] . $data['redirect']);
                exit();
            }
        }
    ...
    public function alterar_evento($idApp_Consulta = FALSE) {
        ...
        $data['titulo'] = 'Outros Eventos';
        $data['form_open_path'] = 'consultacli/alterar_evento';
        $data['panel'] = 'primary';
        $data['metodo'] = 2;
        $data['evento'] = 1;
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($data['auditoriaitem'] && $this->Consultacli_model->update_consulta($data['query'], $data['query']['idApp_Consulta']) === FALSE) {
                $data['msg'] = '?m=2';
                redirect(base_url() . 'consultacli/listar/' . $data['query']['idApp_Consulta'] . $data['msg']);
                exit();
            } else {
    ...
    public function alterar_particular($idApp_Consulta = FALSE, $idApp_Agenda = NULL) {
		...
		$data['select']['idApp_Agenda'] = $this->Basico_model->select_agendacli();
        $data['titulo'] = 'Agenda Particular';
        $data['form_open_path'] = 'consultacli/alterar_particular';
        $data['panel'] = 'primary';
        $data['metodo'] = 2;
        $data['evento'] = 1;
