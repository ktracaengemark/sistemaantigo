...
class Atividade extends CI_Controller {
    ...
    public function cadastrar3($tabela = NULL) {
        ...
        $data['titulo'] = 'Cadastrar Atividade';
        $data['form_open_path'] = 'atividade/cadastrar3';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 1;
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($data['idApp_Atividade'] === FALSE) {
                ...
                redirect(base_url() . 'atividade/cadastrar3' . $data['msg']);
                exit();
            }
        }
    ...
    public function alterar3($id = FALSE) {
        ...
        $data['titulo'] = 'Editar Atividade';
        $data['form_open_path'] = 'atividade/alterar3';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 2;
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($data['auditoriaitem'] && $this->Atividade_model->update_atividade($data['query'], $data['query']['idApp_Atividade']) === FALSE) {
                $data['msg'] = '?m=2';
                redirect(base_url() . 'atividade/alterar3/' . $data['msg']);
                exit();
            } else {
