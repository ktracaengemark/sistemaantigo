...
define("EMPRESAS", "empresas_testes3");
    ...
    public function registrar() {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($data['idSis_Empresa'] === FALSE) {
				...
				$pasta2 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/documentos/';
				mkdir($pasta2, 0777);
				
				$pasta21 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/documentos/original/';
				mkdir($pasta21, 0777);
								
				$pasta22 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/documentos/miniatura/';
				mkdir($pasta22, 0777);				
				
				$arquivo_origem2 = '../' .$empresas.'/1/documentos/miniatura/SuaLogo.jpg';
				$arquivo_destino2 = '../' .$empresas.'/' .$data['idSis_Empresa'].'/documentos/miniatura/SuaLogo.jpg';
				
				copy($arquivo_origem2, $arquivo_destino2);
				
				$pasta3 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/usuarios/';
				mkdir($pasta3, 0777);
				
				$pasta31 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/usuarios/original/';
				mkdir($pasta31, 0777);
				
				$pasta32 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/usuarios/miniatura/';
				mkdir($pasta32, 0777);				

				$arquivo_origem3 = '../' .$empresas.'/1/usuarios/miniatura/SuaFoto.jpg';
				$arquivo_destino3 = '../' .$empresas.'/' .$data['idSis_Empresa'].'/usuarios/miniatura/SuaFoto.jpg';
				
				copy($arquivo_origem3, $arquivo_destino3);				
				
				$pasta4 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/clientes/';
				mkdir($pasta4, 0777);
				
				$pasta41 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/clientes/original/';
				mkdir($pasta41, 0777);
				
				$pasta42 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/clientes/miniatura/';
				mkdir($pasta42, 0777);				
				
				$arquivo_origem4 = '../' .$empresas.'/1/clientes/miniatura/Foto.jpg';
				$arquivo_destino4 = '../' .$empresas.'/' .$data['idSis_Empresa'].'/clientes/miniatura/Foto.jpg';
				
				copy($arquivo_origem4, $arquivo_destino4);
				
				$pasta5 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/produtos/';
				mkdir($pasta5, 0777);
				
				$pasta51 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/produtos/original/';
				mkdir($pasta51, 0777);
				
				$pasta52 = $_UP['pasta'] = '../' .$empresas.'/' .$data['idSis_Empresa'].'/produtos/miniatura/';
				mkdir($pasta52, 0777);				
				
				$arquivo_origem5 = '../' .$empresas.'/1/produtos/miniatura/fotoproduto.jpg';
				$arquivo_destino5 = '../' .$empresas.'/' .$data['idSis_Empresa'].'/produtos/miniatura/fotoproduto.jpg';
