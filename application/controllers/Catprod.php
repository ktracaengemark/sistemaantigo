...
class Catprod extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Catprod_model', 'Prodaux1_model', 'Prodaux2_model', 'idTab_Catprod_model', 'Prodaux4_model', 'Fornecedor_model', 'Formapag_model', 'Relatorio_model'));
