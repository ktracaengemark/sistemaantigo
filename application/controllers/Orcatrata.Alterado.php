...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        for ($i = 1; $i <= $data['count']['SCount']; $i++) {
            ...
            if ($this->input->post('idTab_Produto' . $i) || $this->input->post('ValorCompraProduto' . $i) ||
					$this->input->post('QtdCompraProduto' . $i) || $this->input->post('SubtotalServico' . $i) ||
					$this->input->post('ObsProduto' . $i) || $this->input->post('DataValidadeProduto' . $i) || 
					$this->input->post('ConcluidoServico' . $i)) {
                $data['servico'][$j]['idTab_Produto'] = $this->input->post('idTab_Produto' . $i);
                $data['servico'][$j]['ValorCompraProduto'] = $this->input->post('ValorCompraProduto' . $i);
                $data['servico'][$j]['QtdCompraProduto'] = $this->input->post('QtdCompraProduto' . $i);
                $data['servico'][$j]['SubtotalServico'] = $this->input->post('SubtotalServico' . $i);
                $data['servico'][$j]['ObsProduto'] = $this->input->post('ObsProduto' . $i);
                $data['servico'][$j]['DataValidadeProduto'] = $this->input->post('DataValidadeProduto' . $i);
            ...
            */
            ...
            if (isset($data['servico'])) {
                ...
                for($j=1;$j<=$max;$j++) {
                    ...
                    $data['servico'][$j]['ValorCompraProduto'] = str_replace(',', '.', str_replace('.', '', $data['servico'][$j]['ValorCompraProduto']));
                    unset($data['servico'][$j]['SubtotalServico']);
                }
                $data['servico']['idApp_ProdutoCompra'] = $this->Orcatrata_model->set_servico_venda($data['servico']);
            }
            ...
            */
            ...
            if (isset($data['servico'])) {
                ...
                for($j=1;$j<=$max;$j++) {
					...
					$data['servico'][$j]['idTab_Modulo'] = $_SESSION['log']['idTab_Modulo'];
                    $data['servico'][$j]['idApp_OrcaTrata'] = $data['orcatrata']['idApp_OrcaTrata'];
					$data['servico'][$j]['TipoProduto'] = "DEVO";
					$data['servico'][$j]['DataValidadeProduto'] = $this->basico->mascara_data($data['servico'][$j]['DataValidadeProduto'], 'mysql');
                    $data['servico'][$j]['ValorCompraProduto'] = str_replace(',', '.', str_replace('.', '', $data['servico'][$j]['ValorCompraProduto']));
                    unset($data['servico'][$j]['SubtotalServico']);
                }
            ...
            if (isset($data['produto'])) {
                ...
                for($j=1;$j<=$max;$j++) {
					...
					$data['produto'][$j]['idTab_Modulo'] = $_SESSION['log']['idTab_Modulo'];
                    $data['produto'][$j]['idApp_OrcaTrata'] = $data['orcatrata']['idApp_OrcaTrata'];
					$data['produto'][$j]['TipoProduto'] = "VEND";
					$data['produto'][$j]['DataValidadeProduto'] = $this->basico->mascara_data($data['produto'][$j]['DataValidadeProduto'], 'mysql');
                    $data['produto'][$j]['ValorVendaProduto'] = str_replace(',', '.', str_replace('.', '', $data['produto'][$j]['ValorVendaProduto']));
                    unset($data['produto'][$j]['SubtotalProduto']);
                }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        for ($i = 1; $i <= $data['count']['SCount']; $i++) {
            ...
            if ($this->input->post('idTab_Produto' . $i) || $this->input->post('ValorCompraProduto' . $i) ||
					...
					$this->input->post('ObsProduto' . $i) || $this->input->post('DataValidadeProduto' . $i) || 
					$this->input->post('ConcluidoServico' . $i)) {
                $data['servico'][$j]['idApp_ProdutoCompra'] = $this->input->post('idApp_ProdutoCompra' . $i);
                $data['servico'][$j]['idTab_Produto'] = $this->input->post('idTab_Produto' . $i);
                $data['servico'][$j]['ValorCompraProduto'] = $this->input->post('ValorCompraProduto' . $i);
                $data['servico'][$j]['QtdCompraProduto'] = $this->input->post('QtdCompraProduto' . $i);
                $data['servico'][$j]['SubtotalServico'] = $this->input->post('SubtotalServico' . $i);
            ...
            if (count($data['servico']) > 0) {
                ...
                if (isset($data['servico'])) {
                    ...
                    for($j=1;$j<=$data['count']['SCount'];$j++) {
                        $data['servico'][$j]['SubtotalServico'] = number_format(($data['servico'][$j]['ValorCompraProduto'] * $data['servico'][$j]['QtdCompraProduto']), 2, ',', '.');
        ...
        */
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if (isset($data['servico']) || (!isset($data['servico']) && isset($data['update']['servico']['anterior']) ) ) {
                ...
                $data['update']['servico'] = $this->basico->tratamento_array_multidimensional($data['servico'], $data['update']['servico']['anterior'], 'idApp_ProdutoCompra');
                ...
                for($j=0;$j<$max;$j++) {
                    ...
                    $data['update']['servico']['inserir'][$j]['ValorCompraProduto'] = str_replace(',', '.', str_replace('.', '', $data['update']['servico']['inserir'][$j]['ValorCompraProduto']));
                ...
                for($j=0;$j<$max;$j++) {
					...
					$data['update']['servico']['alterar'][$j]['ValorCompraProduto'] = str_replace(',', '.', str_replace('.', '', $data['update']['servico']['alterar'][$j]['ValorCompraProduto']));
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if (isset($data['servico']) || (!isset($data['servico']) && isset($data['update']['servico']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
					...
					$data['update']['servico']['inserir'][$j]['idTab_Modulo'] = $_SESSION['log']['idTab_Modulo'];
                    $data['update']['servico']['inserir'][$j]['idApp_OrcaTrata'] = $data['orcatrata']['idApp_OrcaTrata'];
					$data['update']['servico']['inserir'][$j]['TipoProduto'] = "DEVO";
					$data['update']['servico']['inserir'][$j]['DataValidadeProduto'] = $this->basico->mascara_data($data['update']['servico']['inserir'][$j]['DataValidadeProduto'], 'mysql');
                    $data['update']['servico']['inserir'][$j]['ValorCompraProduto'] = str_replace(',', '.', str_replace('.', '', $data['update']['servico']['inserir'][$j]['ValorCompraProduto']));
                    unset($data['update']['servico']['inserir'][$j]['SubtotalServico']);
                }
            ...
            if (isset($data['produto']) || (!isset($data['produto']) && isset($data['update']['produto']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
					...
					$data['update']['produto']['inserir'][$j]['idTab_Modulo'] = $_SESSION['log']['idTab_Modulo'];
                    $data['update']['produto']['inserir'][$j]['idApp_OrcaTrata'] = $data['orcatrata']['idApp_OrcaTrata'];
					$data['update']['produto']['inserir'][$j]['TipoProduto'] = "VEND";
					$data['update']['produto']['inserir'][$j]['DataValidadeProduto'] = $this->basico->mascara_data($data['update']['produto']['inserir'][$j]['DataValidadeProduto'], 'mysql');
                    $data['update']['produto']['inserir'][$j]['ValorVendaProduto'] = str_replace(',', '.', str_replace('.', '', $data['update']['produto']['inserir'][$j]['ValorVendaProduto']));
                    unset($data['update']['produto']['inserir'][$j]['SubtotalProduto']);
                }
            ...
            if (isset($data['parcelasrec']) || (!isset($data['parcelasrec']) && isset($data['update']['parcelasrec']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
					...
					$data['update']['parcelasrec']['inserir'][$j]['idTab_Modulo'] = $_SESSION['log']['idTab_Modulo'];
                    $data['update']['parcelasrec']['inserir'][$j]['idApp_OrcaTrata'] = $data['orcatrata']['idApp_OrcaTrata'];
					$data['update']['parcelasrec']['inserir'][$j]['TipoRD'] = "R";
                    $data['update']['parcelasrec']['inserir'][$j]['ValorParcelaRecebiveis'] = str_replace(',', '.', str_replace('.', '', $data['update']['parcelasrec']['inserir'][$j]['ValorParcelaRecebiveis']));
                    $data['update']['parcelasrec']['inserir'][$j]['DataVencimentoRecebiveis'] = $this->basico->mascara_data($data['update']['parcelasrec']['inserir'][$j]['DataVencimentoRecebiveis'], 'mysql');
                    $data['update']['parcelasrec']['inserir'][$j]['ValorPagoRecebiveis'] = str_replace(',', '.', str_replace('.', '', $data['update']['parcelasrec']['inserir'][$j]['ValorPagoRecebiveis']));
                    $data['update']['parcelasrec']['inserir'][$j]['DataPagoRecebiveis'] = $this->basico->mascara_data($data['update']['parcelasrec']['inserir'][$j]['DataPagoRecebiveis'], 'mysql');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if ($_SESSION['log']['idSis_Empresa']) {
            #### Sis_Empresa ####
            $data['orcatrata'] = $this->Orcatrata_model->get_orcatrataalterar($_SESSION['log']['idSis_Empresa']);
			$data['orcatrata']['DataOrca'] = $this->basico->mascara_data($data['orcatrata']['DataOrca'], 'barras');
        ...
        */
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data['update']['orcatrata']['anterior'] = $this->Orcatrata_model->get_orcatrataalterar($_SESSION['log']['idSis_Empresa']);
            $data['update']['orcatrata']['campos'] = array_keys($data['orcatrata']);
            $data['update']['orcatrata']['auditoriaitem'] = $this->basico->set_log(
                $data['update']['orcatrata']['anterior'],
                $data['orcatrata'],
            ...
            $data['update']['orcatrata']['bd'] = $this->Orcatrata_model->update_orcatrataalterar($data['orcatrata'], $_SESSION['log']['idSis_Empresa']);
            ...
            if (isset($data['parcelasrec']) || (!isset($data['parcelasrec']) && isset($data['update']['parcelasrec']['anterior']) ) ) {
                ...
                if (count($data['update']['parcelasrec']['inserir']))
                    $data['update']['parcelasrec']['bd']['inserir'] = $this->Orcatrata_model->set_parcelasrecalterar($data['update']['parcelasrec']['inserir']);

                if (count($data['update']['parcelasrec']['alterar']))
                    $data['update']['parcelasrec']['bd']['alterar'] =  $this->Orcatrata_model->update_parcelasrecalterar($data['update']['parcelasrec']['alterar']);

                if (count($data['update']['parcelasrec']['excluir']))
                    $data['update']['parcelasrec']['bd']['excluir'] = $this->Orcatrata_model->delete_parcelasrecalterar($data['update']['parcelasrec']['excluir']);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        for ($i = 1; $i <= $data['count']['PRCount']; $i++) {
            ...
            if ($this->input->post('idSis_Empresa' . $i) || $this->input->post('idApp_OrcaTrata' . $i) ||
		...
		if ( 1 != 3 ) {	
            ...
            if (isset($data['parcelasrec']) || (!isset($data['parcelasrec']) && isset($data['update']['parcelasrec']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    ...
                    $data['update']['parcelasrec']['inserir'][$j]['idSis_Empresa'] = $_SESSION['log']['idSis_Empresa'];
					$data['update']['parcelasrec']['inserir'][$j]['idTab_Modulo'] = $_SESSION['log']['idTab_Modulo'];
					$data['update']['parcelasrec']['inserir'][$j]['idApp_OrcaTrata'] = $data['update']['parcelasrec']['inserir'][$j]['idApp_OrcaTrata'];
					$data['update']['parcelasrec']['inserir'][$j]['idApp_Cliente'] = $_SESSION['Cliente']['idApp_Cliente'];
                    $data['update']['parcelasrec']['inserir'][$j]['ValorParcelaRecebiveis'] = str_replace(',', '.', str_replace('.', '', $data['update']['parcelasrec']['inserir'][$j]['ValorParcelaRecebiveis']));
                    $data['update']['parcelasrec']['inserir'][$j]['DataVencimentoRecebiveis'] = $this->basico->mascara_data($data['update']['parcelasrec']['inserir'][$j]['DataVencimentoRecebiveis'], 'mysql');
                    $data['update']['parcelasrec']['inserir'][$j]['ValorPagoRecebiveis'] = str_replace(',', '.', str_replace('.', '', $data['update']['parcelasrec']['inserir'][$j]['ValorPagoRecebiveis']));
