...
class Procedimentocli_model extends CI_Model {
    ...
    public function set_procedimentocli($data) {
    ...
    public function get_procedimentocli($data) {
    ...
    public function update_procedimentocli($data, $id) {
    ...
    public function delete_procedimentocli($data) {
        ...
        */
        ...
        $this->db->delete('App_ProcedimentoCli', array('idApp_ProcedimentoCli' => $data));
    ...
    public function lista_procedimentocli($data, $x) {

        $query = $this->db->query('SELECT * '
                . 'FROM App_ProcedimentoCli WHERE '
	...
	public function select_procedimentocli($data = FALSE) {
        ...
        if ($data === TRUE) {
            ...
            WHERE
                idTab_Modulo = ' . $_SESSION['log']['idTab_Modulo'] . ' AND
                idSis_Empresa = ' . $_SESSION['log']['idSis_Empresa'] . ' AND
				idSis_UsuarioCli = ' . $_SESSION['log']['id'] . '
			ORDER BY 
				Procedimento ASC'
    );
            ...
            $array = array();
            foreach ($query->result() as $row) {
                $array[$row->idApp_ProcedimentoCli] = $row->Procedimento;
            }
        }
