...
class Relatorio_model extends CI_Model {
	...
	public function list_receitas_Orig($data, $completo) {
	...
	public function list_despesas_Orig($data, $completo) {
	...
	public function list_receitasparc_Orig($data, $completo) {
	...
	public function list_despesasparc_Orig($data, $completo) {
	...
	public function list1_cobrancas($data, $completo) {
	...
	public function list1_debitos($data, $completo) {
        ...
        $query = $this->db->query(
            'SELECT
				CONCAT(IFNULL(C.idApp_Fornecedor,""), " - " ,IFNULL(C.NomeFornecedor,""), " - " ,IFNULL(C.Telefone1,""), " - " ,IFNULL(C.Telefone2,""), " - " ,IFNULL(C.Telefone3,"") ) AS NomeFornecedor,
                OT.idApp_OrcaTrata,
				OT.Tipo_Orca,
				OT.idSis_Usuario,
				OT.idTab_TipoRD,
    ...
    public function list1_comissao_Original($data, $completo) {
...
exit();*/
    ...
    public function list_orcamento_Original($data, $completo) {
    ...
    public function list_orcamento2($data, $completo) {
		...
		$data['TipoFrete'] = ($data['TipoFrete']) ? ' AND TTF.idTab_TipoFrete = ' . $data['TipoFrete'] : FALSE;
		$data['TipoFinanceiroD'] = ($data['TipoFinanceiroD']) ? ' AND TR.idTab_TipoFinanceiro = ' . $data['TipoFinanceiroD'] : FALSE;
        $data['Campo'] = (!$data['Campo']) ? 'C.NomeFornecedor' : $data['Campo'];
        $data['Ordenamento'] = (!$data['Ordenamento']) ? 'ASC' : $data['Ordenamento'];
		$filtro1 = ($data['AprovadoOrca'] != '#') ? 'OT.AprovadoOrca = "' . $data['AprovadoOrca'] . '" AND ' : FALSE;
        $filtro2 = ($data['QuitadoOrca'] != '#') ? 'OT.QuitadoOrca = "' . $data['QuitadoOrca'] . '" AND ' : FALSE;
		$filtro3 = ($data['ConcluidoOrca'] != '#') ? 'OT.ConcluidoOrca = "' . $data['ConcluidoOrca'] . '" AND ' : FALSE;
    ...
    public function list_orcamento2_original($data, $completo) {
