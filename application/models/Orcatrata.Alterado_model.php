...
class Orcatrata_model extends CI_Model {
	...
	public function get_servico($data) {
		$query = $this->db->query('SELECT * FROM App_ProdutoCompra WHERE idApp_OrcaTrata = ' . $data);
        $query = $query->result_array();
    ...
    public function delete_servico_venda($data) {
        ...
        //$query = $this->db->delete('App_ProdutoCompra', array('idApp_ProdutoCompra' => $data));
    ...
    public function delete_orcatrata($id) {
        ...
        /*
        $tables = array('App_ProdutoCompra', 'App_ProdutoVenda', 'App_ParcelasRecebiveis', 'App_Procedimento', 'App_OrcaTrata');
        $this->db->where('idApp_Orcatrata', $id);
        $this->db->delete($tables);
        */

        $query = $this->db->delete('App_ProdutoCompra', array('idApp_Orcatrata' => $id));
