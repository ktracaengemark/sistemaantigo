...
$tipocategoria = filter_var($Dados['TipoCatprod'], FILTER_SANITIZE_STRING);
...
$query_usuario = "INSERT INTO Tab_Catprod (Catprod, TipoCatprod,  idSis_Usuario, idSis_Empresa, idTab_Modulo) VALUES ('$catprod', '$tipocategoria', '$usuario', '$empresa', '$modulo')";
