...
$query_usuario = "INSERT INTO Tab_Catprom (Catprom, TipoCatprom,  idSis_Usuario, idSis_Empresa, idTab_Modulo) VALUES ('$catprom', '$tipocategoria', '$usuario', '$empresa', '$modulo')";
