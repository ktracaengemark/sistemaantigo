...
elseif ($_GET['q'] == 90) {
    ...
    $result = mysql_query('
            SELECT
				...
				TDS.Desconto,
				TPM.Promocao,
				CONCAT(IFNULL(P.Nome_Prod,""), " - ",  IFNULL(TOP2.Opcao,""), " - ", IFNULL(TOP1.Opcao,""), " - ", IFNULL(V.Convdesc,""), " - ", IFNULL(TDS.Desconto,""), " - ", IFNULL(TPM.Promocao,""), " - R$", IFNULL(V.ValorProduto,"")) AS NomeProduto
            FROM
                Tab_Valor AS V
